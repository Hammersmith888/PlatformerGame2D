...
public class EnemyControler : MonoBehaviour
{
    ...
    private Vector2 _leftBoundatyPosition;
    ...
    private void Start() {
        ...
        _leftBoundatyPosition = transform.position;
        _rightBoundaryPosition = _leftBoundatyPosition + Vector2.right * walkDistance; 
    ...
    private bool ShouldWait(){
        ...
        bool isOutOfLeftBoundary = !_isFacingRight && transform.position.x <= _leftBoundatyPosition.x;
    ...
    private void OnDrawGizmos() {
        ...
        Gizmos.DrawLine(_leftBoundatyPosition, _rightBoundaryPosition);
    }
    void Flip() {
